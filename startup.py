...
nficon = PhotoImage(file= "Sprites/new_file.png")
nf = ttk.Button(filemenu, image=nficon, command=new)
nf.place(x=0,y=0)
oficon = PhotoImage(file="Sprites/open_file.png")
of = ttk.Button(filemenu, image=oficon, command=openfile)
of.place(x=55, y=0)
svicon = PhotoImage(file="Sprites/save.png")
