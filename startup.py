...
nf.place(x=0,y=0)
oficon = PhotoImage(file=r"C:\Users\crina\PycharmProjects\CaPybara\Sprites\open_file.png")
of = ttk.Button(filemenu, image=oficon, command=openfile)
of.place(x=55, y=0)
svicon = PhotoImage(file=r"C:\Users\crina\PycharmProjects\CaPybara\Sprites\save.png")
sv = ttk.Button(filemenu, image=svicon, command=save)
sv.place(x=(55*2), y=0)
svaicon= PhotoImage(file=r"C:\Users\crina\PycharmProjects\CaPybara\Sprites\save_as.png")
sva = ttk.Button(filemenu, image=svaicon, command=saveas)
sva.place(x=(55*3), y=0)
clicon = PhotoImage(file=r"C:\Users\crina\PycharmProjects\CaPybara\Sprites\clear.png")
cl = ttk.Button(filemenu, image=clicon, command=clear)
cl.place(x=(55*4), y=0)
rnicon = PhotoImage(file=r"C:\Users\crina\PycharmProjects\CaPybara\Sprites\play.png")
rn= ttk.Button(filemenu, image=rnicon, command=run_code)
rn.place(x=(55*5), y=0)
tuticon = PhotoImage(file=r"C:\Users\crina\PycharmProjects\CaPybara\Sprites\tutorial.png")
tut = ttk.Button(filemenu, image=tuticon, command=course)
tut.place(x=(55*6), y=0)
infoicon = PhotoImage(file=r"C:\Users\crina\PycharmProjects\CaPybara\Sprites\info.png")
