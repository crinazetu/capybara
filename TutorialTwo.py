...
class TutorialTwo(Frame):
    ...
    def pageone(self):
        labelst.destroy()
        label = ttk.Label(self, text="Nice, now change 'var' into \"message\" and \"val\" into \"Hello world!\"", justify='left', wraplength=290, anchor='center', font=fontstyle)
        label.place(relx=0, rely=0)


    def pagetwo(self):
        labelst.destroy()
        label = ttk.Label(self, text="You're almost there. Now change the \"hello world\" inside of the \"print\" line to "
